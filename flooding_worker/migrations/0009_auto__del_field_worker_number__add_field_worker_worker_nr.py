...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Worker.number'
        db.delete_column('flooding_worker_worker', 'number')

        # Adding field 'Worker.worker_nr'
        db.add_column('flooding_worker_worker', 'worker_nr', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Worker.number'
        db.add_column('flooding_worker_worker', 'number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Worker.worker_nr'
        db.delete_column('flooding_worker_worker', 'worker_nr')
