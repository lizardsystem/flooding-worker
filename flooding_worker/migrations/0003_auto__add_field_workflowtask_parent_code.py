...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkflowTask.parent_code'
        db.add_column('flooding_worker_workflowtask', 'parent_code', self.gf('django.db.models.fields.related.ForeignKey')(related_name='workflowtask_parent_task_code', null=True, to=orm['flooding_worker.TaskType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WorkflowTask.parent_code'
        db.delete_column('flooding_worker_workflowtask', 'parent_code_id')
