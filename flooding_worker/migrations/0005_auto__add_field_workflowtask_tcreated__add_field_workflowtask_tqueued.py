...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkflowTask.tcreated'
        db.add_column('flooding_worker_workflowtask', 'tcreated', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'WorkflowTask.tqueued'
        db.add_column('flooding_worker_workflowtask', 'tqueued', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WorkflowTask.tcreated'
        db.delete_column('flooding_worker_workflowtask', 'tcreated')

        # Deleting field 'WorkflowTask.tqueued'
        db.delete_column('flooding_worker_workflowtask', 'tqueued')
