...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workflow.tcreated'
        db.add_column('flooding_worker_workflow', 'tcreated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 22, 10, 38, 5, 262158), null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Workflow.tcreated'
        db.delete_column('flooding_worker_workflow', 'tcreated')
    ...
    models = {
        ...
        'flooding_worker.workflow': {
            ...
            'tcreated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 22, 10, 38, 5, 262158)', 'null': 'True', 'blank': 'True'}),
        ...
        'flooding_worker.workflowtask': {
            ...
            'tcreated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 22, 10, 38, 5, 264318)', 'null': 'True', 'blank': 'True'}),
            'tfinished': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
