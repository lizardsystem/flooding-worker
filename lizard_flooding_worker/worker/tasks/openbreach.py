...
#
# $Id: openbreach.py 22356 2011-07-04 20:22:55Z bastiaan.roos $
#
# initial programmer :  Mario Frasca
# initial date       :  <yyyymmdd>
#***********************************************************************

__revision__ = "$Rev: 22356 $"[6:-2]
...
import lizard_flooding.models, lizard_base.models
...
def set_broker_logging_handler(broker_handler=None):
    ...
    if broker_handler is not None:
        ...
        log.warning("Broker logging handler isn't set, will use default handler.")
